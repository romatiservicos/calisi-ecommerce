<?php 
class EM_Em0121settings_Model_Config_Font
{
	const CACHE_KEY = 'em0121settings_GOOGLE_FONTS';
	const CACHE_LIFETIME = 86400;
	
	protected $googlefonts_url = 'https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=AIzaSyAA8UhC3NuXX3EBpSHWpOsNXyl5R-Yswvo';
