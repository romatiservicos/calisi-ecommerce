...
class EM_Slideshow2_Block_Adminhtml_Slider_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  protected function _beforeToHtml()
  {
	  ...
	  $this->addTab('form_video', array(
          'label'     => Mage::helper('slideshow2')->__('Video Upload'),
          'title'     => Mage::helper('slideshow2')->__('Video Upload'),
          'content'   => $this->getLayout()->createBlock('slideshow2/adminhtml_slider_edit_tab_video')->toHtml(),
      ));
